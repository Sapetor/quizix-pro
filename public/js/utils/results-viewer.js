...
import { bindElement, dom, show, hide } from './dom.js';
import {
    openModal,
    closeModal,
    bindOverlayClose,
...
} from './results-viewer/results-comparison.js';
...
export class ResultsViewer {
    ...
    displayComparisonSelectorModal(quizzesWithSessions) {
        ...
        const modal = createComparisonSelectorModal(quizzesWithSessions);
        document.body.appendChild(modal);
    ...
    showSessionSelector(quizTitle, quizzesWithSessions) {
        ...
        const modal = createSessionSelectorModal(quizTitle, quiz);
        document.body.appendChild(modal);
    ...
    displayComparisonResults(quizTitle, comparisonData) {
        ...
        const modal = createComparisonResultsModal(quizTitle, comparisonData);
        document.body.appendChild(modal);
