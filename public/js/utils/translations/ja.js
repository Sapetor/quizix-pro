export default {
    ...
    onboarding_step3_title: '質問の種類',
    onboarding_step3_content: '選択式、正誤、複数回答、数値回答、並べ替え問題から選択できます。',
    onboarding_step4_title: '画像を追加',
    onboarding_step4_content: '画像を質問にドラッグ＆ドロップするか、クリックして選択。画像でクイズをより魅力的に！',
    ...
    onboarding_step6_content: 'クイズを保存して後で続けましょう。フォルダアイコンで保存済みクイズを読み込めます。',
